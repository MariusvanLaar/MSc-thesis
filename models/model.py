...
class TestModel(nn.Module):
    def __init__(self, n_blocks: int, n_qubits: int):
        ...
        self.Rz2 = Rz_layer(n_blocks, n_qubits)
    ...
    def forward(self, x):
        ...
        state[:, :, :, 0, 0] = 1
        Ry = Ry_layer(self.n_blocks, self.n_qubits, weights=x)
        #Ry2 = Ry_layer(self.n_blocks, self.n_qubits, weights=x[1])
